...
- (void)setDefaultValues{
    ...
    self.weekDayTextFont = [UIFont systemFontOfSize:14];
     self.weekDayTextColor = [UIColor colorWithRed:153./256. green:153./256. blue:153./256. alpha:1.];
    ...
    self.dayBorderColorToday = [UIColor colorWithRed:76/255.0 green:165/255.0 blue:251/255.0 alpha:1];
    self.dayCircleColorSelected  = [UIColor colorWithRed:76/255.0 green:165/255.0 blue:251/255.0 alpha:1];
    self.dayCircleColorToday = [UIColor colorWithRed:76/255.0 green:165/255.0 blue:251/255.0 alpha:1];
